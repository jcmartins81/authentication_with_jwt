import {findUSer, findUSerWithResetToken, updateUserIfNewPassword, updateUserIfResetToken} from './databaseService.js'
...
export async function forgotPassword(email) {
    ...
    if(!await updateUserIfResetToken(user.id, token, now)) return ({error: 'Error on forgot password, try again'})
